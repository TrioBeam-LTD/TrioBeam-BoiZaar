...
const bangladeshiBooks: Book[] = [
  // HSC Books
  {
    ...
    image: "https://i.postimg.cc/MHb60svT/kourosh-qaffari-Rrhhzit-Yizg-unsplash.jpg",
    price: 180,
    originalPrice: 350,
    condition: "Good",
    ...
    isFeatured: true,
    isActive: true,
    photos: ["https://i.postimg.cc/MHb60svT/kourosh-qaffari-Rrhhzit-Yizg-unsplash.jpg"],
  },
  {
    id: "2",
